...
const COLLAB_WS_BASE = ''; // SockJS will connect to /collab — Vite proxy routes to collab-service:8084
    ...
    const connect = () => {
      client = new Client({
        ...
        onWebSocketError: (event) => {
          ...
          setConnectionError(`Could not connect to collaboration server. Make sure collab-service is running on port 8084.`);
          setSessionStatus('Error');
          setRetryCount(c => c + 1);
        },
      });
